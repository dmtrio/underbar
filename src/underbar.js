(function() {
  ...
  _.filter = function(collection, test) {
    ...
    //console.log(collection);
     _.each(collection, function(item){
       if (test(item) === true) {
          testPassedArray.push(item);
       }
     });
     return testPassedArray;
  };
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(lastFound, item){
      if (lastFound == false){
  ...
  _.extend = function(obj) {
    //take object and extend it with passed through arguments
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      var existingIndex = alreadyCalled.indexOf(JSON.stringify(arguments));

        if (existingIndex < 0){
          var tempResult = func.apply(this, arguments)
          results.push(tempResult);
          alreadyCalled.push(JSON.stringify(arguments));
          return tempResult;
        }
  ...
  _.shuffle = function(array) {
    ...
    var newArray = [];
    var countArray = array.slice();

    while (countArray.length > 0) {
      var rand = Math.floor(Math.random() * countArray.length);
